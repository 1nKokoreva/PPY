...
public class MyGui extends JFrame {
    ...
    public MyGui() {
        ...
        JButton cityButton = new JButton("Uzyskaj pogodę dla miasta w textfield");
        ...
        JButton nbpButton = new JButton("Uzyskaj stawkę dla kraju w textfield");
        JLabel nbpLabel = new JLabel();

        JPanel ratePanel = new JPanel();
        JTextField currencyCodeTextField = new JTextField();
        currencyCodeTextField.setText("USD");
        JButton currencyButton = new JButton("Uzyskaj kurs waluty w polu tekstowym");
        ...
        weatherTextArea.setPreferredSize(new Dimension(600, 200));
        ...
        JButton loadPageButton = new JButton("Załaduj stronę");
